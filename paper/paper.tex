...
\author{\IEEEauthorblockN{Nitesh Kumar Yadav, Yash Mittal, and Sajan}
...
answers \ConfCNNCovNinety\% of inputs, at \ConfCNNAccNinety\% accuracy on those it
answers. The SVM answers \ConfSVMCovNinety\% --- a coverage ratio of
...
weaker form, with SVM coverage of \ConfSVMmodCovNinety\% at the same gate.
...
and regularization techniques,'' \emph{Signal Processing}, vol.~242,
art.~110444, 2026.
